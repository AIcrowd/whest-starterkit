...
| [03_covariance_propagation.py](03_covariance_propagation.py) | medium | ~0.0000046 | 51,709,240,799 (2.351%) | Track full covariance, not only diagonal variance — costlier but more accurate |
...
The MSE values use sampling seed 0 with the local helper's independent reference
stream for n=100k; they include finite-reference sampling noise.
...
same three examples measure ~0.84, ~0.00030 and ~0.0000058 on the ranked metric, so
