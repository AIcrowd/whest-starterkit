...
prompt "uv run whest run --estimator estimator.py --runner local --n-mlps 20 --n-samples 100000 --seed 42"
uv run whest run --estimator estimator.py --runner local --n-mlps 20 --n-samples 100000 --seed 42
