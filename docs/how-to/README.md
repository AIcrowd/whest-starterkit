...
| [ship-weights.md](ship-weights.md) | Pre-compute offline and load weights in `setup()` via `submission_dir`; multi-file submissions; 50 MB / 50 file caps; `.whestignore`; package preview and `--dry-run`. |
