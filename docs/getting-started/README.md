...
| 4 | `uv run whest run --estimator estimator.py --dataset hf://aicrowd/arc-whestbench-public-2026@v2-phase2 --split mini --runner subprocess` | Subprocess isolation — catches state-bleed between MLPs, dirty imports, RNG re-use. | [stage-4-run-subprocess.md](stage-4-run-subprocess.md) |
